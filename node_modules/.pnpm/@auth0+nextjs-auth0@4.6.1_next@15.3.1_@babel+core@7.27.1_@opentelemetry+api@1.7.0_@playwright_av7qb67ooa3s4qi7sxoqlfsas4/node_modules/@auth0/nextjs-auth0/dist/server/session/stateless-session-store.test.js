    ...
    describe("set", async () => {
        describe("with rolling sessions enabled", async () => {
            ...
            it("should delete the legacy cookie chunks if they exists", async () => {
                ...
                expect(responseCookies.delete).toHaveBeenNthCalledWith(1, LEGACY_COOKIE_NAME);
                expect(responseCookies.delete).toHaveBeenNthCalledWith(2, `${LEGACY_COOKIE_NAME}.0`);
                expect(responseCookies.delete).toHaveBeenNthCalledWith(3, `${LEGACY_COOKIE_NAME}.1`);
            });
        });
