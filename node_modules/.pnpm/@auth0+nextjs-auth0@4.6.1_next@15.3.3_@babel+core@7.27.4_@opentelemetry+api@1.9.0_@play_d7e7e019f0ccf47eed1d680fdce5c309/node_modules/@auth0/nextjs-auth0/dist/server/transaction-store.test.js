...
describe("Transaction Store", async () => {
    ...
    describe("deleteAll", async () => {
        it("should delete all cookies starting with the prefix", async () => {
            ...
            expect(responseCookies.get("__txn_state1")?.expires).toEqual(new Date("1970-01-01T00:00:00.000Z"));
            expect(responseCookies.get("__txn_state2")?.value).toEqual("");
            expect(responseCookies.get("__txn_state2")?.expires).toEqual(new Date("1970-01-01T00:00:00.000Z"));
        ...
        it("should respect custom prefix when deleting cookies", async () => {
            ...
            expect(responseCookies.get(`${customPrefix}state1`)?.expires).toEqual(new Date("1970-01-01T00:00:00.000Z"));
